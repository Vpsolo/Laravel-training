          ...
          <div class="hero_section">
            <div class="row">
              ...
              <div class="col-lg-7 col-sm-5">
                ...
                {!! Html::image('public/assets/img/'.$page->images) !!}
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="inner_section">
            <div class="row">
              <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right">
                {{-- <img src="{{ asset('public/assets/img/about-img.jpg') }}" class="img-circle delay-03s animated wow zoomIn" alt=""> --}}
                {!! Html::image('public/assets/img/'.$page->images,'',array('class'=>'img-circle delay-03s animated wow zoomIn')) !!}
              </div>
  ...
  <div class="portfolio">
    ...
    <div class="isotope fadeInLeft animated wow" style="position: relative; overflow: hidden; height: 480px;"
      ...
      <div
        ...
        <div class="portfolio_img"> <img src="{{ asset('public/assets/img/portfolio_pic1.jpg') }}" alt="Portfolio 1">
        </div>
      ...
      <div
        ...
        <div class="portfolio_img"> <img src="{{ asset('public/assets/img/portfolio_pic2.jpg') }}" alt="Portfolio 1">
        </div>
        <div class="item_overlay">
          <div class="item_info">
      ...
      <div
        ...
        class="portfolio-item one-four  design  isotope-item">
        <div class="portfolio_img"> <img src="{{ asset('public/assets/img/portfolio_pic3.jpg') }}" alt="Portfolio 1">
        </div>
        <div class="item_overlay">
          <div class="item_info">
      ...
      <div
        ...
        <div class="portfolio_img"> <img src="{{ asset('public/assets/img/portfolio_pic4.jpg') }}" alt="Portfolio 1">
        </div>
        <div class="item_overlay">
          <div class="item_info">
      ...
      <div
        ...
        class="portfolio-item one-four  design isotope-item">
        <div class="portfolio_img"> <img src="{{ asset('public/assets/img/portfolio_pic5.jpg') }}" alt="Portfolio 1">
        </div>
        <div class="item_overlay">
          <div class="item_info">
      ...
      <div
        ...
        <div class="portfolio_img"> <img src="{{ asset('public/assets/img/portfolio_pic6.jpg') }}" alt="Portfolio 1">
        </div>
        <div class="item_overlay">
          <div class="item_info">
      ...
      <div
        ...
        <div class="portfolio_img"> <img src="{{ asset('public/assets/img/portfolio_pic7.jpg') }}" alt="Portfolio 1">
        </div>
        <div class="item_overlay">
          <div class="item_info">
      ...
      <div
        ...
        <div class="portfolio_img"> <img src="{{ asset('public/assets/img/portfolio_pic8.jpg') }}" alt="Portfolio 1">
        </div>
        <div class="item_overlay">
          <div class="item_info">
