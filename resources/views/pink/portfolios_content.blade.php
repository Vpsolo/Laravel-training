    ...
    <div id="portfolio" class="portfolio-big-image">
      ...
      <div class="hentry work group">
        <div class="work-thumbnail">
          <div class="nozoom">
            <img src="{{ asset('public/'.env('THEME')) }}/images/projects/{{ $portfolio->img->max }}" alt="0061" title="0061" />
            <div class="overlay">
              <a class="overlay_img" href="{{ asset('public/'.env('THEME')) }}/images/projects/{{ $portfolio->img->path }}" rel="lightbox" title="{{ $portfolio->title }}"></a>
