...
<div id="content-home" class="content group">
  <div class="hentry group">
    <div class="section portfolio">
      ...
      <h3 class="title">{{ trans('ru.latest_works') }}</h3>

      @foreach ($portfolios as $k=>$item)
        @if ($k == 0)
        <div class="hentry work group portfolio-sticky portfolio-full-description">
          <div class="work-thumbnail">
            <a class="thumb"><img src="{{ asset('public/'.env('THEME')) }}/images/projects/{{ $item->img->max }}" alt="0081"
                title="0081" /></a>
        ...
        <div class="related_project {{ ($k==4) ? 'related_project_last' : '' }}">
          <div class="overlay_a related_img">
            <div class="overlay_wrapper">
              ...
              <div class="overlay">
                <a class="overlay_img" href="{{ asset('public/'.env('THEME')) }}/images/projects/{{ $item->img->path }}"
