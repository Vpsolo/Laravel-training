...
<div id="slider-cycle" class="slider cycle no-responsive slider_cycle group" style="height:485px;">
  <ul class="slider">
    ...
    <li>
      <div class="slide-holder" style="background:  url('{{ asset('public/'.env('THEME')) }}/images/{{ $slider->img }}') no-repeat center center"
        style="height:483px;">
    ...
    <div class="yit-widget-content inner group">
      ...
      <div class="yit-widget widget col1_4 one-fourth col widget-last-post group">
        ...
        <div>
          ...
          <p>Section shortcodes &amp; sticky posts! <a href="{{ asset('public/'.env('THEME')) }}/article.html"> | more
              →</a></p>
        </div>
      </div>
      <div class="widget-last yit-widget widget col1_4 one-fourth col yit_text_quote">
        <blockquote class="text-quote-quote">“Anyone who has never made a mistake has never tried anything new.”
        </blockquote>
...
<div class="mobile-slider">
  <div class="slider fixed-image inner"><img
      src="{{ asset('public/'.env('THEME')) }}/images/slider-cycle/cycle-fixed.jpg" alt="" /></div>
</div>
@endif