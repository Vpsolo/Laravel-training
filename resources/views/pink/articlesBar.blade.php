<div class="widget-first widget recent-posts">
  ...
  <div class="recent-post group">
    @if (!$portfolios->isEmpty())
      ...
      <div class="hentry-post group">
        <div class="thumb-img"><img style="width:55px" src="{{ asset('public/'.env('THEME')) }}/images/projects/{{ $portfolio->img->mini }}" alt="001" title="001" /></div>
        <div class="text">
  ...
  {{-- <div class="recent-post group">
    ...
    <div class="hentry-post group">
      ...
      <div class="text">
        <a href="article.html" title="Nice &amp; Clean. The best for your blog!" class="title">Nice &amp;
    ...
    <div class="hentry-post group">
      ...
      <div class="text">
        <a href="article.html" title="Another theme by YIThemes!" class="title">Another theme by
          YIThemes!</a>
...
<div class="widget-last widget recent-comments">
  ...
  <div class="recent-post recent-comments group">
    ...
    <div class="the-post group">
      ...
      <span class="author"><strong><a href="mailto:no-email@i-am-anonymous.not">eduard</a></strong>
        in</span>
    ...
    <div class="the-post group">
      ...
      <span class="author"><strong><a href="mailto:no-email@i-am-anonymous.not">Anonymous</a></strong>
        in</span>
      <a class="title" href="article.html">This is the title of the first article. Enjoy it.</a>
      <p class="comment">
